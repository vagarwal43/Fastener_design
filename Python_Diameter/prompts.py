test_0 = 'Calculate the optimal major diameter for a bolt given the following parameters: desired safety factor of 1.00, \
 minor diameter of 5 mm, initial major diameter of 8 mm, joint constant of 0.25 N/mm, applied load of 5000 N, preload of 10000 N, pitch of 1.25 mm, and yield strength of 350 MPa'
...
Determine the required major diameter of the bolt that meets the desired safety factor under axial loading if \
Applied Axial Load: 50,000 N \
Desired Safety Factor: 2.0 \
Minor Diameter of Bolt: 18 mm \
Initial Major diameter: 24 mm \
Preload: 80,000 N \
Joint Constant: 0.30 \
Thread Pitch: 2 mm \
