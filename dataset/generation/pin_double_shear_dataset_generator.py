...
# function to determining the minimum viable pin diameter for a pin in double shear given the following, and assuming a
# nominal area, and that allowable shear ~= 0.5*yield strength: force, factor of safety, yield strength
# F: force in N
...
if __name__ == '__main__':
    ...
    print(f"min pin diameter: {min_pin_diameter(100, 2, 250)} mm")
